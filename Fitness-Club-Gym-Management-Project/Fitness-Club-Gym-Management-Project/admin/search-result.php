...
<!--Header-part-->
<div id="header">
  <h1><a href="">Fitness Club Admin</a></h1>
</div>
<!--close-Header-part--> 
        ...
        <thead>
          <tr>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='user-payment.php?id=".$row['user_id']."'><button class='btn btn-success btn'><i class='fas fa-euro-sign'></i> Make Payment</button></a></div></td>
