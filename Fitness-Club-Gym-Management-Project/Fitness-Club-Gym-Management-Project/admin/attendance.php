            ...
            <div class='widget-content nopadding'> 
              <table class='table table-bordered table-hover'>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    if (isset($row['id'])) {  // Vérification de l'existence de 'id'
                ?>
                ...
                <tbody>
                    <tr>
                        ...
                        if ($num_count > 0) {
                            ...
                            if (isset($row_exist['curr_date']) && $row_exist['curr_date'] == $todays_date) {
                        ?>
                        <td>
                            ...
                            <div class='text-center'>
                                <a href='actions/delete-attendance.php?id=<?php echo $row['id'];?>'>
                        ...
                        <td>
                            <div class='text-center'>
                                <a href='actions/check-attendance.php?id=<?php echo $row['id'];?>'>
