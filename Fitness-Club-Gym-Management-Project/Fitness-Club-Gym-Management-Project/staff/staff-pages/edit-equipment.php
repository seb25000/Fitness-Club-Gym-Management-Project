...
<html lang="en">
<head>
<title>Fitness Club Staff A/C</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Fitness Club Staff A/C</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Fitness Club's Equipment List <i class="icon icon-cogs"></i></h1>
  </div>
